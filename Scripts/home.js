...
window.addEventListener('DOMContentLoaded', () => {
  setTimeout(() => {
    ...
    }, 1200); // Logo appears 1.2 seconds after page load
    ...
    }, 2000); // Navigation appears 2 seconds after page load
    ...
    navItems.forEach((item, i) => {
      ...
      }, 2500 + i * 100); // Start after navigation appears
    });
    ...
    if (floatingBook) {
      ...
      }, 3000); // Book appears 3 seconds after page load
    }
  }, 400);
});
...
document.querySelector('.hero-cta').addEventListener('mouseenter', function() {
  this.style.transform = 'translateY(-3px) scale(1.02)';
});

document.querySelector('.hero-cta').addEventListener('mouseleave', function() {
